...
class MoneydanceSyncableItem(com.infinitekind.tiksync.SyncableItem):
    ...
    def getSublistParameter(self, s: str) -> List[com.infinitekind.tiksync.SyncRecord]: ...
...
class Account(MoneydanceSyncableItem):
    ...
    def getBankingServices(self) -> List['OnlineServiceLink']: ...
...
class AccountUtil:
    ACCOUNT = 5
    ACCOUNT_NAME = 17
    ACCOUNT_NAME_COMPARATOR = 'com.infinitekind.moneydance.model.AccountUtil$1@7868369e'
    ACCOUNT_TYPE_NAME_CASE_INSENSITIVE_COMPARATOR = 'com.infinitekind.moneydance.model.AccountUtil$$Lambda$481/0x000000080045b170@166a7c64'
    ACCOUNT_TYPE_NAME_COMPARATOR = 'com.infinitekind.moneydance.model.AccountUtil$$Lambda$480/0x000000080045aef0@59322e0b'
    ACTION = 10
    AMOUNT = 3
    AMOUNT_COMPARATOR = 'com.infinitekind.moneydance.model.AccountUtil$3@11b58f26'
    CATEGORY = 13
    CATEGORY_NAME = 18
    CHECKNUM = 9
    CHECKNUM_INT = 11
    ...
    DATE = 0
    DATE_ENTERED = 1
    DATE_ENTERED_COMPARATOR = 'com.infinitekind.moneydance.model.AccountUtil$2@28d09748'
    DATE_THEN_AMOUNT = 7
    DATE_THEN_AMOUNT_COMPARATOR = 'com.infinitekind.moneydance.model.AccountUtil$4@6d9c576a'
    ...
    TXN_CATEGORY_THEN_DATE_ENTERED = 'com.infinitekind.moneydance.model.AccountUtil$5@25966ea4'
    TXN_DATE_THEN_CHECKNUM = 'com.infinitekind.moneydance.model.AccountUtil$6@18e7198f'
    TXN_DESCRIPTION = 'com.infinitekind.moneydance.model.AccountUtil$8@34a1b70c'
    TXN_TAXDATE_THEN_CHECKNUM = 'com.infinitekind.moneydance.model.AccountUtil$7@3b0981f5'
    ...
    @staticmethod
    def getInvestmentCategoryComparator(b: bool, b2: bool) -> Callable[[Txn, Txn], int]: ...
...
class AddressBook:
    comparator = 'com.infinitekind.moneydance.model.AddressBook$1@25f0e3f1'
...
class CurrencyUtil:
    CURRENCY_NAME_COMPARATOR = 'com.infinitekind.moneydance.model.CurrencyUtil$1@9648074'
    CURRENCY_TYPENAME_COMPARATOR = 'com.infinitekind.moneydance.model.CurrencyUtil$2@3ccd53d9'
...
class OnlineAccountMapping:
    def __init__(self, accountBook: AccountBook, onlineService: 'OnlineService'): ...
    ...
    @staticmethod
    def findServiceReferencesToAccount(account: Account) -> List['OnlineServiceLink']: ...
    
    @staticmethod
    def findUnmatchedReferences(accountBook: AccountBook, onlineService: 'OnlineService') -> List[str]: ...
    
    def getAccountForOnlineID(self, s: str, account: Account) -> Account: ...
    
    def getKnownOnlineAccounts(self) -> List[str]: ...
    
    @staticmethod
    def localTypesForOnlineAccountType(onlineAccountInfo: OnlineAccountInfo) -> List[str]: ...
    ...
    class NameAndID:
        accountID = '<reflected field public final java.lang.String com.infinitekind.moneydance.model.OnlineAccountMapping$NameAndID.accountID at 0x2f>'
        accountName = '<reflected field public final java.lang.String com.infinitekind.moneydance.model.OnlineAccountMapping$NameAndID.accountName at 0x30>'
...
class OnlineServiceLink:
    accountID = '<reflected field public final java.lang.String com.infinitekind.moneydance.model.OnlineServiceLink.accountID at 0x31>'
    onlineServiceID = '<reflected field public final java.lang.String com.infinitekind.moneydance.model.OnlineServiceLink.onlineServiceID at 0x32>'
    
    def __init__(self, s: str, s2: str, account: Account): ...
    
    def addIfUniqueAndFound(self, list: List['OnlineServiceLink']) -> None: ...
...
class PeriodTypeFilter:
    FILTER_LARGER = 'com.infinitekind.moneydance.model.PeriodTypeFilter$LargerPeriodTypeFilter@6e53c0bc'
    FILTER_LARGER_OR_EQUAL = 'com.infinitekind.moneydance.model.PeriodTypeFilter$LargerPeriodTypeFilter@63723f9f'
    FILTER_NARROWER = 'com.infinitekind.moneydance.model.PeriodTypeFilter$NarrowerPeriodTypeFilter@24c89c57'
    FILTER_NARROWER_OR_EQUAL = 'com.infinitekind.moneydance.model.PeriodTypeFilter$NarrowerPeriodTypeFilter@456146a3'
...
class TransactionSet(Iterable):
    ...
    def getTxns(self, txnSearch: TxnSearch, sequence: Sequence[Txn]) -> Sequence[Txn]: ...
...
class TxnSet(Iterable):
    ...
    def sortWithComparator(self, callable: Callable[[Txn, Txn], int]) -> None: ...
...
class TxnUtil:
    ...
    OTHER_ACCOUNT_THEN_DATE_COMPARATOR = 'com.infinitekind.moneydance.model.TxnUtil$8@5977ac56'
    ...
    @staticmethod
    def comparatorForField(i: int) -> Callable[[Txn, Txn], int]: ...
